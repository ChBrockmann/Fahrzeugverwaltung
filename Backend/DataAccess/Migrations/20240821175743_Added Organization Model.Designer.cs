...
namespace DataAccess.Migrations
{
    ...
    [Migration("20240821175743_Added Organization Model")]
    partial class AddedOrganizationModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdentityRole<Guid>InvitationModel", b =>
                {
                    ...
                    b.HasKey("InvitationModelId", "RolesId");

                    b.HasIndex("RolesId");

                    b.ToTable("IdentityRole<Guid>InvitationModel");
                });
            ...
            modelBuilder.Entity("OrganizationUserModel", b =>
                {
                    ...
                    b.HasKey("Organization1Id", "UsersId");
            ...
            modelBuilder.Entity("Model.Organization.Organization", b =>
                {
                    b.HasOne("Model.User.UserModel", "Owner")
                        .WithMany()
